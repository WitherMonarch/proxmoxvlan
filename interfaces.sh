...
if [[ "$install_nginx" == "y" || "$install_nginx" == "Y" ]]; then
    ...
    read -p "Enter the Fully Qualified Domain Name (FQDN) of the Proxmox server (e.g., proxmox.example.com): " fqdn

    # Create an NGINX reverse proxy configuration for Proxmox using FQDN
